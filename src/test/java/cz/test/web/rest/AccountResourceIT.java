package cz.test.web.rest;

import static cz.test.web.rest.AccountResourceIT.TEST_USER_LOGIN;
import static org.assertj.core.api.Assertions.assertThat;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import cz.test.TestApp;
import cz.test.config.Constants;
import cz.test.domain.User;
import cz.test.repository.AuthorityRepository;
import cz.test.repository.UserRepository;
import cz.test.security.AuthoritiesConstants;
import cz.test.service.UserService;
import cz.test.service.dto.PasswordChangeDTO;
import cz.test.service.dto.UserDTO;
import cz.test.web.rest.vm.KeyAndPasswordVM;
import cz.test.web.rest.vm.ManagedUserVM;
